export type TUserActivationEmail = {
  hello: string
  userName: string
  welcomeActivateEmailMessage: string
  ignoreEmailMessage: string
  confirmAccount: string
  confirmAccountLink: string
  allRightsReserved: string
}

export const UserActivationEmailTemplate = `
<!DOCTYPE html>
<html lang="pt-BR">
  <head>
    <meta charset="utf-8" />
        ...
        >
          <tbody>
            <tr>
              ...
              >
                <img
                  src="" alt="logo"  style="max-width: 100%; max-height: 100%; width: 100; height: 100;"
                />
              </td>
            </tr>
          </tbody>
